        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">수금 수정</h1>
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="table-responsive">
                            	<form action="${pageContext.request.contextPath}/sl/sales/collectMoney/modifyCollectOk.do" name="modifyForm" method="post">
                            		<input type="hidden" name="coIdx" value="${collectVO.coIdx}">
                                ...
                                <div class="btn_bottom_wrap">
									<button type="submit" class="btn_ok" onclick="fn_modify_collect()" style="border:none;">확인</button>
	...
	function deliveryInfoAjax(){
		$.ajax({
			  ...
			  success:function(result){
				  ...
				  modifyForm.aIdx.value = result.de_info[0].aIdx;
				  
				  var tot = result.de_info[0].deMoney;
				  var vat = result.de_info[0].deMoney/10;
				  modifyForm.coTot.value = tot-vat;
				  modifyForm.coVat.value = vat;
				  modifyForm.coTotPrice.value = tot;
			  },
