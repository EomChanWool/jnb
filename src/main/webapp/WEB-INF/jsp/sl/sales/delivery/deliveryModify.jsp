                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                            	<form action="${pageContext.request.contextPath}/sl/sales/delivery/modifyDeliveryOk.do" name="modifyForm" method="post">
                            		<input type="hidden" name="deIdx" value="${deliveryVO.deIdx}">
                            		<input type="hidden" name="orIdx" id="orIdx" value="${deliveryVO.orIdx}">
                            		<input type="hidden" name="acCode" value="${deliveryVO.acCode}">
	                                <table class="table table-bordered" id="dataTable">
	                                    <tbody>
											<tr>
												<th>수주코드 <span class="req">*</span></th>
												<td><span class="form-control val-area">${deliveryVO.orIdx}</span></td>
												<th>납품명 <span class="req">*</span></th>
												<td><input type="text" class="form-control" name="deName" id="deName" value="${deliveryVO.deName}"></td>
											</tr>
											<tr>
												<th>거래처번호</th>
											...
											<tr>
												...
												<td>
													<select class="form-control" name="deState" id="deState">
														...
														<option value="0" <c:if test="${deliveryVO.deState eq '0'}">selected="selected"</c:if>>대기</option>
	...
	function deliveryOrdersInfoAjax(){
		$.ajax({
			  ...
			  success:function(result){
				  ...
				  modifyForm.acCode.value = result.orders_info.acCode;
			  },
