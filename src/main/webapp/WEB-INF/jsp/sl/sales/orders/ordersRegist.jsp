                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="table-responsive">
                            	<form action="${pageContext.request.contextPath}/sl/sales/ordersManage/registOrdersOk.do" name="registForm" method="post">
	                                <table class="table table-bordered" id="dataTable">
	                                    <tbody>
										<tr>
											<th>수주명  <span class="req">*</span></th>
											<td><input type="text" class="form-control" name="orName" id="orName"/></td>
											<th>수주일  <span class="req">*</span></th>
											<td><input type="date" class="form-control" name="orDte" id="orDte"/></td>
										</tr>
										<tr>
											<th>견적서번호  <span class="req">*</span></th>
											<td>
												<input type="text" class="form-control" name="esIdx" id="esIdx" list="list" autocomplete="off">
												<datalist id="list">
													<option value="">선택</option>
													<c:forEach var="list" items="${estimateList}" varStatus="status">
														<option value="${list.esIdx}">${list.esName}</option>
													</c:forEach>
												</datalist>
											</td>
											<th>자사 담당자</th>
										...
										<tr>
											...
											<th>화폐단위</th>
											<td><input type="text" class="form-control" name="orMnyUnit" id="orMnyUnit" value="원"/></td>
										</tr>
										<tr>
											<th>수주낙찰가  <span class="req">*</span></th>
											<td><input type="text" class="form-control" name="orBidPrice" id="orBidPrice"/></td>
											<th>납기일  <span class="req">*</span></th>
											<td><input type="date" class="form-control" name="orDueDte" id="orDueDte"/></td>
										</tr>
										<tr>
											<th>최초 견적일</th>
										...
										<tr>
											...
											<td colspan="3"><input type="text" class="form-control" name="orDuePlace" id="orDuePlace"/></td>
										</tr>
										<tr>
											<th>비고</th>
											<td colspan="3"><textarea name="orNote"></textarea></td>
										</tr>
									</tbody>
	                                </table>
                                </form>
                                <div class="btn_bottom_wrap">
									<button type="submit" class="btn_ok" onclick="fn_regist_orders()" style="border:none;">확인</button>
	...
	function estimateInfoAjax(){
		$.ajax({
			  ...
			  success:function(result){
				  $('#orMoney').val(result.estimate_ajax[0].esFQM);
