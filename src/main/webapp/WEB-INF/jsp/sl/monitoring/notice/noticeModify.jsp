                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="table-responsive">
                            	<form action="${pageContext.request.contextPath}/sl/monitoring/notice/modifyNoticeOk.do" name="registForm" method="post">
                            		<input type="hidden" name="noIdx" value="${noticeVO.noIdx}">
	                                <table class="table table-bordered" id="dataTable">
	                                    <tbody>
											<tr>
												<th>제목  <span class="req">*</span></th>
												<td><input type="text" class="form-control" name="noTitle" id="noTitle" value="${noticeVO.noTitle}"></td>
												<th>공개여부 <span class="req">*</span></th>
												<td>
													<select class="form-control" name="noUse" id="noUse">
														<option value="">선택</option>
														<option value="공개" <c:if test="${noticeVO.noUse eq '공개'}">selected="selected"</c:if>>공개</option>
														<option value="비공개" <c:if test="${noticeVO.noUse eq '비공개'}">selected="selected"</c:if>>비공개</option>
													</select>
												</td>
											</tr>
											<tr>
												<th>내용  <span class="req">*</span></th>
												<td colspan="3"><textArea name="noCont" id="noCont" style="height:300px;">${noticeVO.noCont}</textArea></td>
											</tr>
										</tbody>
	                                </table>
                                </form>
