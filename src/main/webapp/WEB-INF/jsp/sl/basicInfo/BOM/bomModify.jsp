                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="table-responsive">
                            	<form action="${pageContext.request.contextPath}/sl/basicInfo/bom/modifyBomOk.do" name="modifyForm" method="post">
                            		<input type="hidden" name="bIdx" value="${bomVO.bIdx}">
	                                <table class="table table-bordered">
	                                    <tbody>
											<tr>
												<th>제품코드 <span class="req">*</span></th>
												<td colspan="3">
													<input type="text" class="form-control" name="itemCd" id="itemCd" value="${bomVO.itemCd}" list="pdList" autocomplete="off" disabled="disabled"/>
												</td>
											</tr>
										</tbody>
	                                </table>
                                ...
                                <div class="btn_bottom_wrap">
									<button type="submit" class="btn_ok" onclick="fn_modify_bom()" style="border:none;">확인</button>
