                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                            	<form action="${pageContext.request.contextPath}/sl/basicInfo/member/registMemberOk.do" name="registForm" method="post">
                            		<input type="hidden" name="useableId" id="useableId" value="${memVO.useableId}">
	                                <table class="table table-bordered" id="dataTable">
	                                    <tbody>
											<tr>
												...
												<td>
													<input type="text" class="form-control" name="mId" id="mId" value="${memVO.mId}" style="width:77%; float: left;"/>
