        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">사업장 등록</h1>
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="table-responsive">
                            	<form action="${pageContext.request.contextPath}/sl/basicInfo/company/registCompanyOk.do" name="registForm" method="post">
	                                <table class="table table-bordered" id="dataTable"  >
	                                    <tbody>
											...
											<tr>
												<th>사업자등록번호</th>
												<td><input type="text" class="form-control" name="cBsnsNo" id="cBsnsNo" value="${companyVO.cRegitNo}"/></td>
												<th>대표자</th>
											...
											<tr>
												<th>현장정보</th>
												<td colspan="3"><input type="text" class="form-control" name="cSiteInfo" id="cSiteInfo"/>${companyVO.cSiteInfo}</td>
											</tr>
											<tr>
												<th>비고</th>
                                ...
                                <div class="btn_bottom_wrap">
									<button type="submit" class="btn_ok" onclick="fn_regist_company()" style="border:none;">확인</button>
