        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">설비 수정</h1>
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="table-responsive">
                            	<form action="${pageContext.request.contextPath}/sl/basicInfo/facility/modifyFacilityOk.do" name="modifyForm" method="post">
                            		<input type="hidden" name="faIdx" value="${facilityVO.faIdx}">
                            		<input type="hidden" name=fCode value="${facilityVO.fCode}">
	                                <table class="table table-bordered" id="dataTable"  >
	                                    <tbody>
											<tr>
												<th>공장명 <span class="req">*</span></th>
												<td>
													<input type="text" class="form-control" name="fName" id="fName" value="${facilityVO.fName}" list="coList" autocomplete="off" readonly/>
											...
											<tr>
												<th>비가동 사유</th>
												<td colspan="3"><input type="text" class="form-control" name="noReason" id="noReason" value="${facilityVO.noReason}"></td>
											</tr>
                                ...
                                <div class="btn_bottom_wrap">
									<button type="submit" class="btn_ok" onclick="fn_modify_facility()" style="border:none;">확인</button>
