	                                ...
	                                <table class="table table-bordered" id="dataTable">
	                                    <tbody>
											<tr>
												...
												<td><span class="form-control val-area" id="oiItemName"></span><input type="hidden" name="oiItemName"></td>
											</tr>
											<tr>
												<th>수량  <span class="req">*</span></th>
												<td><input type="text" class="form-control" name="oiCnt" id="oiCnt"></td>
												<th>출고일  <span class="req">*</span></th>
												<td><input type="datetime-local" class="form-control" name="oiOutDte" id="oiOutDte"></td>
											</tr>
											<tr>
												<th>입고일</th>
												<td><input type="datetime-local" class="form-control" name="oiInDte" id="oiInDte"></td>
												<th>검사일</th>
												<td><input type="datetime-local" class="form-control" name="oiIspDte" id="oiIspDte"></td>
											</tr>
											<tr>
												<th>담당자</th>
	...
	function itemInfoAjax(){
		$.ajax({
			  ...
			  success:function(result){
				  ...
				  registForm.oiItemName.value = result.wo_info[0].itemName;
