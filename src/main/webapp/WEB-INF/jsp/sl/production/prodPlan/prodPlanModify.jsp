        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">생산계획 수정</h1>
                    <!-- DataTales Example -->
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                            	<form action="${pageContext.request.contextPath}/sl/production/prodPlan/modifyProdPlanOk.do" name="modifyForm" method="post">
                            		...
                            		<input type="hidden" name="orIdx" id="orIdx" value="${prodPlanVO.orIdx}">
	                                <table class="table table-bordered" id="dataTable">
	                                    <tbody>
											<tr>
												<th>수주번호 <span class="req">*</span></th>
												<td><span class="form-control val-area">${prodPlanVO.orIdx}</span></td>
												<th>생산계획명 <span class="req">*</span></th>
												<td><input type="text" class="form-control" name="ppName" id="ppName" value="${prodPlanVO.ppName}"></td>
											</tr>
											<tr>
												<th>제품코드 <span class="req">*</span></th>
												<td>
													<input type="text" class="form-control" name="itemCd" id="itemCd" value="${prodPlanVO.itemCd}" list="itList" autocomplete="off">
													<datalist id="itList"></datalist>
												</td>
												<th>생산량 (kg)<span class="req">*</span></th>
												<td><input type="text" class="form-control" name="ppPrdtCnt" id="ppPrdtCnt" value="${prodPlanVO.ppPrdtCnt}"></td>
											</tr>
											<tr>
												<th>납품예정일</th>
												<td><input type="date" class="form-control" name="ppDlvDte" id="ppDlvDte" value="${prodPlanVO.ppDlvDte}"></td>
											</tr>
											<tr>
												<th>비고</th>
												<td colspan="3"><textArea name="ppNote">${prodPlanVO.ppNote}</textArea></td>
											</tr>
										</tbody>
	                                </table>
                                </form>
                                <div class="btn_bottom_wrap">
									<button type="submit" class="btn_ok" onclick="fn_modify_prodPlan()" style="border:none;">확인</button>
