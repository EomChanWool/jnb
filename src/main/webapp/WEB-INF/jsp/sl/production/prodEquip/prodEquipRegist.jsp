        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">생산설비정보 등록</h1>
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="table-responsive">
                            	<form action="${pageContext.request.contextPath}/sl/production/prodEquip/registProdEquipOk.do" name="registForm" method="post">
	                                <table class="table table-bordered" id="dataTable">
	                                    <tbody>
											<tr>
												<th>설비명  <span class="req">*</span></th>
												<td><input type="text" class="form-control" name="faName" id="faName"></td>
												<th>적용공정  <span class="req">*</span></th>
												<td>
													<input type="text" class="form-control" name="faCtlVal" id="faCtlVal" list="prList" autocomplete="off"/>
													<datalist id="prList">
                                ...
                                <div class="btn_bottom_wrap">
									<button type="submit" class="btn_ok" onclick="fn_regist_prodEquip()" style="border:none;">확인</button>
